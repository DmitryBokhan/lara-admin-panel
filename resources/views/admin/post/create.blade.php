            ...
            <form action="{{ route('post.store') }}" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control" id="categoryInput" placeholder="Введите название категории" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="feature_image">Выбрать изображение</label>
                  ...
                  <a href="" class="popup_selector" data-inputid="feature_image">Выбрать</a>
              </div>
               </div>
